        ...
        {statusItems.map((item, idx) => (
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-500 text-[10px] font-black uppercase tracking-tighter border border-emerald-500/20">
      ...
      <div className="p-8 rounded-3xl bg-gradient-to-br from-gray-900 via-gray-900 to-blue-900/10 border border-gray-800/50">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center py-3 border-b border-gray-800">
            ...
            <span className="text-gray-200 font-mono text-sm">v2.4.0-prod</span>
          </div>
          <div className="flex justify-between items-center py-3">
            <span className="text-gray-400 text-sm">Uptime (30d)</span>
            <span className="text-gray-200 font-mono text-sm">99.98%</span>
          </div>
        </div>
      </div>
